...
- [x] Helper
    - [x] Calling RestApis (ApiCaller)
    - [x] Amount handling (IOTA/SMR)
    - [x] Convert strings, hex, byteArray, base64, base58, ad25519, canonicalize, serialize (Converter)
    - [x] Hashing pbldf2, blake2b, hmacSha512, sha256, sha512 (Hash)
    - [x] Classes
        - [x] Curl
        - [x] JSON
        - [x] Keys
